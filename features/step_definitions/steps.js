...
module.exports = function () {
  this.Given(/^I visit online calculator$/, function() {
    return this.driver.get('https://www.online-calculator.com/full-screen-calculator/');
    
  });

  this.Then(/^I should see online calculator in title$/, function() {
    this.driver.getTitle().then(function (title) {
      assert.equal(title, "Full Screen Calculator - Online Calculator");
      return title;
    });
  });

  this.Given(/^Open firefox browser and start application$/, function () {
...
this.Then(/^I should be able to see {int}/, function (table) {
  var strResult=dataTable.raw()[3][1];
  this.driver.getResult().then(function (result) {
